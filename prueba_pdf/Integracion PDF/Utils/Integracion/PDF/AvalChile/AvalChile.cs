...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.AvalChile
{
    class AvalChile
    {
        #region Variables
        ...
        private const string RutPattern = "RUT 76";
        private const string OrdenCompraPattern = "N°";
        private const string ItemsHeaderPattern =
            "Código Item Cantidad Valor Valor Total";
        ...
        public AvalChile(PDFReader pdfReader)
        {
