...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.ClinicaLilas
{
    public class ClinicaLilas
    {
        #region Variables
        ...
        private const string ItemsHeaderPattern =
            "Unitario Descto. Descto";

        private const string CentroCostoPattern = "Observaciones: ";
        ...
        public ClinicaLilas(PDFReader pdfReader)
        {
        ...
        {
            var aux = str.Substring(str.IndexOf("RUT: ", StringComparison.Ordinal) + 5, 12);
            return aux;
        }
