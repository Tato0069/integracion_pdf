...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.FoodFantasy
{
    public class FoodFantasy
    {
        #region Variables
        ...
        public FoodFantasy(PDFReader pdfReader)
        {
            ...
            //foreach(var str in pdfLines)
            {
                ...
                switch (optItem)
                {
                    case 0:
                        ...
                        for (var j = i; j < i + 4; j++)
                        {
                            if (pdfLines[j].Contains("CODIGO"))
                            {
                                var a = pdfLines[j].Split(' ');
                                sku = a[1];
                            }
                        }
                        item0.Sku = sku;
