...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.CapacitacionCienciasTecnologiaLimitada
{
    class CapacitacionCienciasTecnologiasLimitada
    {
        #region Variables
        ...
        private const string ItemsHeaderPattern =
            "Código Descripción Marca Cantidad Precio Total";
        ...
        public CapacitacionCienciasTecnologiasLimitada(PDFReader pdfReader)
        {
        ...
        public OrdenCompra.OrdenCompra GetOrdenCompra()
        {
            ...
            for (var i = 0; i < _pdfLines.Length; i++)
            {
                if (!_readOrdenCompra)
                {
                    ...
                    {
                        OrdenCompra.NumeroCompra = GetOrdenCompra(_pdfLines[i].DeleteContoniousWhiteSpace());
            ...
            //foreach(var str in pdfLines)
            {
                ...
                switch (optItem)
                {
                    case 0:
                        ...
                        {
                            Sku = test0[0],
                            Cantidad = test0[test0.Length - 3].Replace(".", "").Split(',')[0],
        ...
        {
            str = str.Trim().DeleteContoniousWhiteSpace();
            return str.Contains(OrdenCompraPattern) && !str.Contains("_");
        }
