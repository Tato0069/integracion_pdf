...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.HospitalTrabajador
{
    class HospitalTrabajador
    {
        #region Variables
        ...
        public HospitalTrabajador(PDFReader pdfReader)
        {
