...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.InmobiSanCarlos
{
    class InmobiSanCarlos
    {
        #region Variables
        ...
        private const string OrdenCompraPattern = "O/C Número:";
        private const string ItemsHeaderPattern =
            "Fecha Entrega V. Unitario V. Total";
        ...
        public InmobiSanCarlos(PDFReader pdfReader)
        {
