...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.SeidorChile
{
    class SeidorChile
    {
        #region Variables
        ...
        public SeidorChile(PDFReader pdfReader)
        {
        ...
        public OrdenCompra.OrdenCompra GetOrdenCompra()
        {
            OrdenCompra = new OrdenCompra.OrdenCompra
            {
                ...
                NumeroCompra = _pdfReader.PdfFileNameOC
