...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.MaestranzaMParts
{
    class MaestranzaMParts
    {
        #region Variables
        ...
        public MaestranzaMParts(PDFReader pdfReader)
        {
            ...
            //foreach(var str in pdfLines)
            {
                ...
                switch (optItem)
                {
                    case 0:
                        ...
                        {
                            Sku = "W102030",
                            Cantidad = test0[4].Trim(),
                            Precio = test0[5].Replace(",", ""),
                             Descripcion = pdfLines[i+1].Trim(),
