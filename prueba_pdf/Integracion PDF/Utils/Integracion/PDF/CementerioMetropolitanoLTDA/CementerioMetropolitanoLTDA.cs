...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.CementerioMetropolitanoLTDA
{
    class CementerioMetropolitanoLTDA
    {
        #region Variables
        private readonly Dictionary<int, string> _itemsPatterns = new Dictionary<int, string>
        {
            {0, @"\s\d{1,}\sCLP\s\d{1,}\sCLP\s\d{1,}$"},
        };
        private const string RutPattern = "RUT:";
        private const string OrdenCompraPattern = "Orden de Compra";
        private const string ItemsHeaderPattern =
            "Precio Iva Incluido Total";
        ...
        public CementerioMetropolitanoLTDA(PDFReader pdfReader)
        {
