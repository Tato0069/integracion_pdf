...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.OfficeStore
{
    public class OfficeStore
    {
        ...
        private const string ItemsHeaderPattern =
            "Item Código Código Office Store Descriptor Cantidad Valor Unitario Valor Total";
        ...
        private List<Item> GetItems(string[] pdfLines, int i)
        {
            ...
            {
                var aux = pdfLines[i].Trim().Replace("$","").DeleteContoniousWhiteSpace();
        ...
        {
            var aux = str.Split(' ')[1].Substring(0, 10);
            return aux;
        }
