...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF
{
    class AscensoresSchindler
    {
        ...
        private const string RutPattern = "Nuestro R.U.T. :";
        private const string OrdenCompraPattern = "Número/Grupo:";
        private const string ItemsHeaderPattern =
            "Fecha de entrega Cantidad Unidad";
        ...
        public AscensoresSchindler(PDFReader pdfReader)
        {
        ...
        {
            var cc = _pdfReader.ExtractTextByCoOrdinate(1, 410, 460, 480, 600).Replace("\n", ", ");
