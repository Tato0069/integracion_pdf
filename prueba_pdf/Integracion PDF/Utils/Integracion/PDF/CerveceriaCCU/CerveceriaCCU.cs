...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.CerveceriaCCU
{
    class CerveceriaCCU
    {
        #region Variables
        ...
        private const string ItemsHeaderPattern =
            " UM Precio Unitario Monto Fecha Entrega";
        ...
        public CerveceriaCCU(PDFReader pdfReader)
        {
