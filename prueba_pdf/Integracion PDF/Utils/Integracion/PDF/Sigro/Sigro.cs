...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.Sigro
{
    class Sigro
    {
        #region Variables
        ...
        {
            {0, @"\d{1,}\sUN\s[a-zA-Z]{1,}\s"},
            //{1, @"^\d{1,}\s\w{3}\d{5,6}\s\d{1,}\s" }
        };
        private const string RutPattern = "EMPRESA CONSTRUCTORA";
        private const string OrdenCompraPattern = "ORDEN DE COMPRA N°:";
        private const string ItemsHeaderPattern =
            "P. Unitario Descuento Valor Total";
        ...
        public Sigro(PDFReader pdfReader)
        {
