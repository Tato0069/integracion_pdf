...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.Zical
{
    class Zical
    {
        #region Variables
        ...
        private const string OrdenCompraPattern = "O R D E N D E C O M P R A";
        ...
        public Zical(PDFReader pdfReader)
        {
