...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.SociedadEducacionalAraucana
{
    class SociedadEducacionalAraucana
    {
        #region Variables
        ...
        public SociedadEducacionalAraucana(PDFReader pdfReader)
        {
