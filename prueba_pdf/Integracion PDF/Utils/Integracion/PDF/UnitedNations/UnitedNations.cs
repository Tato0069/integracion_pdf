...
namespace IntegracionPDF.Integracion_PDF.Utils.Integracion.PDF.UnitedNations
{
    class UnitedNations
    {
        #region Variables
        ...
        {
            {0, @"^\d{4}\s\d{10}\s\d{1,}\s"},
        };
        private const string RutPattern = "RUT:";
        private const string OrdenCompraPattern = "PURCHASE ORDER NUMBER";
        private const string ItemsHeaderPattern =
            "LINE N ITEM ID / SUPPLIER PART ID QUANTITY";
        ...
        public UnitedNations(PDFReader pdfReader)
        {
